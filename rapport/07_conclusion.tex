...
should dominate, the Three-Cents recognizer~\cite{Caputo2018}, a lightweight
resample--scale--translate template matcher, achieves the highest
user-independent accuracy on both domains ($96.3\%$ on domain~1,
$95.1\%$ on domain~4), outperforming the BiLSTM by a margin of $11$--$21$
percentage points. This result highlights that the inductive bias of
...
template-based methods: DTW and Edit-distance improve by up to $32$ percentage
...
From an applied perspective, the lightweight design and cross-user robustness
of the Three-Cents recognizer make it well-suited for real-time HCI scenarios
where training data are scarce and computational budget is limited, such as
gesture control in AR/VR interfaces, smart-home appliances, and accessibility
tools for users with reduced mobility.
